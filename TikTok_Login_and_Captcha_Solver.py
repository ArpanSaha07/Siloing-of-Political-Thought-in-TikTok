...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="TikTok bot scrapper")

    parser.add_argument(
        "-b", help="Name of bot account to be used", required=True)
    # parser.add_argument(
    #     "-s", help="Name of csv_file", type=str, default="videos.csv")
    ...
    time.sleep(5) # changed the time from 10 to 5
